class UIManager {
    ...
    renderHowToPlay(ctx) {
        ...
        ctx.fillText('🎯 OBJECTIVE', leftX, y);
        y += spacing;
        
        ctx.fillStyle = '#fff';
        ctx.font = '18px Arial';
        ctx.fillText('• Capture and control zones to score points', leftX + 20, y);
        y += spacing - 5;
        ctx.fillText('• First to reach score threshold OR highest score at time limit wins', leftX + 20, y);
        y += spacing - 5;
        ctx.fillText('• Stand on zone for 5 seconds to capture it', leftX + 20, y);
        y += spacing + 10;
        ...
        ctx.fillStyle = '#fff';
        ctx.font = '18px Arial';
        ctx.fillText('Player 1 (Blue):  A/D - Move  |  W - Jump  |  Shift - Shoot', leftX + 20, y);
        y += spacing - 5;
        ctx.fillText('Player 2 (Red):   ←/→ - Move  |  ↑ - Jump  |  Enter - Shoot', leftX + 20, y);
        y += spacing + 10;
        ...
        ctx.fillStyle = '#fff';
        ctx.font = '18px Arial';
        ctx.fillText('• 1 zone captured = 1 point/second', leftX + 20, y);
        y += spacing - 5;
        ctx.fillText('• 2 zones captured = 2 points/second', leftX + 20, y);
        y += spacing - 5;
        ctx.fillText('• More zones = MORE POINTS! Capture them all!', leftX + 20, y);
        y += spacing + 10;
        ...
        ctx.fillStyle = '#fff';
        ctx.font = '18px Arial';
        ctx.fillText('⚡ Speed Boost  |  ↑ Super Jump  |  ⚔ Rapid Fire  |  ⬡ Shield  |  ★ Mega Shot', leftX + 20, y);
